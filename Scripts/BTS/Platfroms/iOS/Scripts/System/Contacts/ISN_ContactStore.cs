...
namespace SA.IOSNative.Contacts {
	...
	public class ContactStore : SA.Common.Pattern.Singleton<ContactStore> {
		...
		private void OnPickerDidSelectContacts(string data) {
            UnityEngine.Debug.Log("[ContactStore] OnPickerDidSelectContacts");
			List<Contact> contacts = ParseContactArray (data);
            UnityEngine.Debug.Log("[ContactStore] Picked " + contacts.Count + " contacts");
		...
		private void OnContactsRetrieveFailed(string errorData) {
            ...
            UnityEngine.Debug.Log("[ContactStore] OnContactsRetrieveFailed");
		...
		private void OnContactsRetrieveFinished(string data) {
            ...
            UnityEngine.Debug.Log("[ContactStore] OnContactsRetrieveFinished");


			List<Contact> contacts = ParseContactArray (data);
            UnityEngine.Debug.Log("[ContactStore] Loaded " + contacts.Count + " contacts");
