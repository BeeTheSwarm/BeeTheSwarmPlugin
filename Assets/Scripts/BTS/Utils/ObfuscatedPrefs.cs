...
namespace BTS {
internal class ObfuscatedPrefs : IPlayerDataLoader {

	public Dictionary<string, ObscuredInt> IntValues 		= new Dictionary<string, ObscuredInt>();
	public Dictionary<string, ObscuredFloat> FloatValues 	= new Dictionary<string, ObscuredFloat>();
	public Dictionary<string, ObscuredString> StringValues 	= new Dictionary<string, ObscuredString>();
