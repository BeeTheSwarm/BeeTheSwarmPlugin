...
namespace SA.UltimateAds {
	...
	public class VungleNetwork : AdNetworkTemplate {
		...
		[SerializeField]
		public bool ShowANPlacements = true;
		[SerializeField]
		public bool ShowIOSPlacements = true;
		[SerializeField]
		public bool ShowWINPlacements = true;

		[SerializeField]
		public List<ANVunglePlacement> ANPlacements = new List<ANVunglePlacement>();

		[SerializeField]
		public List<IOSVunglePlacement> IOSPlacements = new List<IOSVunglePlacement>();

		[SerializeField]
		public List<WinVunglePlacement> WinPlacements = new List<WinVunglePlacement>();
		...
		public override void LoadExampleSettings() {
			...
			ANPlacements.Add (new ANVunglePlacement("ANPLACE17446"));
			ANPlacements.Add (new ANVunglePlacement("GAMEOVE78036"));
		}
